      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid gap-6">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="group bg-gray-50 dark:bg-zinc-800 p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border-l-4 border-mosk-orange hover:bg-white dark:hover:bg-zinc-700"
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-mosk-dark dark:text-white mb-2 group-hover:text-mosk-orange transition-colors">
                        {feature.title}
                      </h3>
                      <p className="text-sm text-mosk-grey dark:text-gray-300 leading-relaxed">
                        {feature.description}
                      </p>
                    </div>
                  </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white dark:border-zinc-700">
              <img 
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -right-6 bg-white dark:bg-zinc-800 p-4 rounded-xl shadow-xl border border-gray-100 dark:border-zinc-700 z-10"
            >
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                <span className="font-bold text-mosk-dark dark:text-white text-sm">7/24 Kesintisiz Hizmet</span>
              </div>
            </motion.div>
            
            {/* Background Decoration */}
            <div className="absolute -z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-mosk-orange/5 rounded-full blur-3xl"></div>
          </motion.div>
